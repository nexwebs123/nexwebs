...
export const Navbar = ({ children, className }: NavbarProps) => {
  ...
  return (
    <motion.div
      ref={ref}
      className={cn("fixed top-4 left-0 right-0 w-full z-50", className)}
  ...
  return (
    <motion.div
      ...
      animate={{
        ...
        boxShadow:
          isHovered && visible
            ? "0 0 32px rgba(34, 42, 53, 0.12), 0 2px 2px rgba(0, 0, 0, 0.08), 0 0 0 1px rgba(34, 42, 53, 0.06), 0 0 8px rgba(34, 42, 53, 0.12), 0 20px 80px rgba(47, 48, 55, 0.08), 0 2px 0 rgba(255, 255, 255, 0.15) inset"
            : visible
              ? "0 0 24px rgba(34, 42, 53, 0.06), 0 1px 1px rgba(0, 0, 0, 0.05), 0 0 0 1px rgba(34, 42, 53, 0.04), 0 0 4px rgba(34, 42, 53, 0.08), 0 16px 68px rgba(47, 48, 55, 0.05), 0 1px 0 rgba(255, 255, 255, 0.1) inset"
              : "none",
        width: visible ? "45%" : "100%",
        height: visible ? "60px" : "72px",
      ...
      {items.map((item, idx) => (
        ...
        >
          <Link
            ...
            onClick={onItemClick}
            className={cn(
              "relative py-2 text-sm font-medium text-neutral-800 dark:text-neutral-300 whitespace-nowrap",
              visible ? "px-3" : "px-4"
            )}
            href={item.link}
          >
      ...
      <AnimatePresence mode="wait">
        {!visible && (
          <motion.span
            ...
            className="dark:text-white text-lg font-bold text-neutral-800 whitespace-nowrap overflow-hidden"
          >
            NEXWEBS
          </motion.span>
        )}
...
export const NavbarButton = ({
  ...
  const variantStyles = {
    primary: "border border-gray-200 dark:border-gray-700 shadow-none",

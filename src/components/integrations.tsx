        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="bg-linear-to-t from-background relative z-20 mx-auto mt-12 max-w-lg space-y-6 from-55% text-center">
            <h2 className="text-balance text-3xl font-semibold md:text-4xl">
              Nexwebs Integrations
            </h2>
            <p className="text-muted-foreground">
              Connect Nexwebs to AI services, deployment platforms, and
              developer tools to accelerate your projects.
            </p>

            <Button variant="outline" size="sm" asChild>
              <Link href="/#contact">Start a project with Nexwebs</Link>
            </Button>
          </div>
        </div>
      </div>
